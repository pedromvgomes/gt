...
// attestGuard skips a stage when the pushed tree already carries a passing
// attestation. Every stage and fixed job shares it, so a squash of an
// already-validated PR runs nothing.
